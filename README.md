...
## Qui fait quoi?
	- Yann, Esteban: parse et check query check.h, expand.h, display_table_record_list (dans record_list.h), sql.h, 
	- POC, Tom : table.h, databse.h, query_exec.h,  record_list (majorité), table.h, utilis.h (références à faire dans le code)
